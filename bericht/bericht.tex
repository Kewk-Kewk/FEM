...
\begin{figure}[H]
\centering
\begin{subfigure}{0.49\linewidth}\includegraphics[width=\linewidth]{Aufgabe_1_1_CFD_Stroemung/figures/mesh_overview_report.png}\caption{Gesamtes CFD-Netz}\end{subfigure}
\begin{subfigure}{0.49\linewidth}\includegraphics[width=\linewidth]{Aufgabe_1_1_CFD_Stroemung/figures/contour_velocity_report.png}\caption{Geschwindigkeitsfeld}\end{subfigure}
\end{figure}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.49\linewidth}\includegraphics[width=\linewidth]{Aufgabe_1_1_CFD_Stroemung/figures/pressure_distribution.png}\caption{Druckverlauf}\end{subfigure}
\begin{subfigure}{0.49\linewidth}\includegraphics[width=\linewidth]{Aufgabe_1_1_CFD_Stroemung/figures/drag_convergence.png}\caption{Widerstandskonvergenz}\end{subfigure}
\end{figure}
...
\begin{table}[H]\centering\small
\input{../Aufgabe_1_2a_Plattenstruktur/data/plate_singularity_study_table.tex}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Aufgabe_1_2a_Plattenstruktur/figures/plate_singularity_mesh_panel.png}
...
\IfFileExists{../Aufgabe_1_2a_Plattenstruktur/figures/plate_singularity_stress_panel.png}{
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Aufgabe_1_2a_Plattenstruktur/figures/plate_singularity_stress_panel.png}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.32\linewidth}\includegraphics[width=\linewidth]{Aufgabe_1_2a_Plattenstruktur/data/plate_line_support_full_height/plate_spannung_eqv_ansys.png}\caption{Linienstützen: Spannung}\end{subfigure}
\begin{subfigure}{0.32\linewidth}\includegraphics[width=\linewidth]{Aufgabe_1_2a_Plattenstruktur/data/plate_line_support_full_height/plate_verformung_ansys.png}\caption{Linienstützen: Verformung}\end{subfigure}
\begin{subfigure}{0.32\linewidth}\includegraphics[width=\linewidth]{Aufgabe_1_2a_Plattenstruktur/figures/A9_Schild_von_hinten_genommen.PNG}\caption{Rückseite (Google Street View, Copyright Google)}\end{subfigure}
...
\begin{table}[H]\centering\footnotesize
\input{../Aufgabe_1_2e_h_Fachwerk_Python/data/truss_comparison_report_table.tex}
...
\includegraphics[height=0.25\textheight]{Aufgabe_1_2e_h_Fachwerk_Python/figures/truss_deformed.png}
\caption{Python-FEM}
\end{subfigure}
\begin{subfigure}{0.48\linewidth}\centering
\includegraphics[height=0.25\textheight]{Aufgabe_1_2b_d_Fachwerk_ANSYS/figures/truss_ansys_force_plot.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{Aufgabe_1_2e_h_Fachwerk_Python/figures/truss_python_ansys_comparison.png}
...
\begin{figure}[H]
\centering
\begin{subfigure}{0.48\linewidth}\centering\includegraphics[width=\linewidth,height=0.14\textheight,keepaspectratio]{Aufgabe_2/figures/mesh_gesamt_report.png}\caption{Globales Netz}\end{subfigure}
\begin{subfigure}{0.48\linewidth}\centering\includegraphics[width=\linewidth,height=0.14\textheight,keepaspectratio]{Aufgabe_2/figures/mesh_zoom_report.png}\caption{Lochrandnetz}\end{subfigure}\\[-1mm]
\begin{subfigure}{0.48\linewidth}\centering\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{Aufgabe_2/figures/normalspannung_report.png}\caption{\(\sigma_y\)}\end{subfigure}
\begin{subfigure}{0.48\linewidth}\centering\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{Aufgabe_2/figures/vergleichspannung_mises_report.png}\caption{von Mises}\end{subfigure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\linewidth]{Aufgabe_2/figures/kerb_convergence.png}
