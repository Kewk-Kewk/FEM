"""Gemeinsamer_Code/apdl_ergebnis_parser.py

Auswertungsbibliothek für die ANSYS MAPDL Schalen- und Fachwerkberechnungsergebnisse.
"""
...
def write_plate_summary_report(
    path: Path,
    values: dict[str, float],
